...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="stock_id" DataSourceID="SqlDataSource1" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black" Height="194px" Visible="False" Width="1001px">
        <Columns>
            ...
            <asp:DynamicField DataField="invoice_date" HeaderText="Date of Invoice">
            <ItemStyle HorizontalAlign="Center" />
            </asp:DynamicField>
        </Columns>
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:alumexConnectionString %>" SelectCommand="SELECT DISTINCT [item_code] FROM [item_tb]"></asp:SqlDataSource>
</asp:Content>
