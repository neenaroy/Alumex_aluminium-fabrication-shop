...
public partial class Guest_Default2 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < dt.Rows.Count; i++)
        {
            ...
            cmd2.Parameters.Add("@model_id", dt.Rows[i][2].ToString());
            ...
            if (dt2.Rows.Count > 0)
            {
                ...
                Panel1.Controls.Add(new LiteralControl("</td></tr>"));
                Panel1.Controls.Add(new LiteralControl("<tr><td> Food Description</td><td>" + dt2.Rows[0][2].ToString()));
                Panel1.Controls.Add(new LiteralControl("</td></tr>"));
                Panel1.Controls.Add(new LiteralControl("<tr><td>Food Cost</td><td>" + dt2.Rows[0][3].ToString()));
                Panel1.Controls.Add(new LiteralControl("</td></tr>"));
                Panel1.Controls.Add(new LiteralControl("<tr><td>"));
              ...
              //  Panel1.Controls.Add(new LiteralControl("<tr><td>Food Quantity </td><td>" + dt.Rows[i][3].ToString()));
                Panel1.Controls.Add(new LiteralControl("</td></tr>"));
                Panel1.Controls.Add(new LiteralControl("<tr><td>"));
                Panel1.Controls.Add(new LiteralControl("<a href=booking.aspx?id=" + dt.Rows[i][0].ToString() + "&id1=1>"));
