<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Index.aspx.cs" Inherits="Guest_Index" %>
					...
					<div class="cd-radial-slider-content">
						<div class="wrapper">
							<div class="text-center">
								...
								<a href="about.aspx" class="read">Read More <i class="fas fa-caret-right"></i></a>
							</div>
						</div>
		...
		<div class="footer-grid">
			...
			<div class="list-footer">
				<ul class="footer-nav text-center">
					...
					<li>
						<a href="View_projects.aspx">Projects</a>
					</li>
					<li>
